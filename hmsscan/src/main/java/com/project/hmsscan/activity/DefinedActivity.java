...
import com.project.hmsscan.view.ScanWechatView;
...
public class DefinedActivity extends Activity {
    ...
    private int[] img = {R.drawable.scankit_flashlight_on, R.drawable.scankit_flashlight_off};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScanWechatView scanView = findViewById(R.id.scan_view);
        ...
        if (resultCode == RESULT_OK && requestCode == REQUEST_CODE_PHOTO) {
            try {
                ...
                if (hmsScans != null && hmsScans.length > 0 && hmsScans[0] != null && !TextUtils.isEmpty(hmsScans[0].getOriginalValue())) {
                    dealOnActivityResult(hmsScans[0]);
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
